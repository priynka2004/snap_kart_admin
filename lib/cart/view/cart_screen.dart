...
import '../../order/model/placed_order_model.dart';
import '../../product/model/add_product_model.dart';
...
class _CartScreenState extends State<CartScreen> {
            ...
            : LayoutBuilder(
                builder: (context, constraints) {
                  if (constraints.maxWidth > 600) {
                    // Web layout for larger screens (GridView)
                    ...
                    // Mobile layout for smaller screens (ListView)
                    return ListView(
  ...
  Future<void> placeOrder(
    ...
    if (shippingAddress != null) {
      ...
      List<ProductOrderItem> productOrderItemList = [];
      for (CartItem cartItem in cartItemList) {
        ProductModel? product = cartItem.product as ProductModel?;   ///////////////////////////////
        if (product != null) {
          productOrderItemList.add(
            ProductOrderItem(
              product: product.id!,
      ...
      if (orderProvider.error == null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Order placement failed: ${orderProvider.error}'),
            backgroundColor: Colors.red,
